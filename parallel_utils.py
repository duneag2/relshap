"""
Source: https://github.com/joaopfonseca/ml-research/blob/master/mlresearch/utils/_parallelize.py
"""
...
def parallel_loop(
    ...
    if progress_bar:
        ...
        with _tqdm_joblib(tqdm(desc=description, total=len(iterable))) as progress_bar:
            return Parallel(n_jobs=n_jobs, backend=backend)(delayed(function)(i) for i in iterable)
