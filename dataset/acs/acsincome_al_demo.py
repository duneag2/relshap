...
out_path = build_acs_duckdb(acs_data, out_path="./acs/acsincome_al.duckdb")
...
DB_PATH = "./acs/acsincome_al.duckdb"
...
SQL_PATH = "./acs/query_acsincome_al_demo.sql"
...
con.close()
df_original = df
df = df.drop(["SERIALNO", "SPORDER", "PINCP"],axis=1)
...
df_original["PINCP"] = (df_original["PINCP"] > 5000).astype(int)
...
flattened_al_demo.to_csv(
    "./acs/flattened_acsincome_al_demo.csv",
    header=feature_list,
    index=False
)